...
public abstract class CameraActivity extends AppCompatActivity
    ...
    public void switchCamera() {
        ...
        if (useFacing == CameraCharacteristics.LENS_FACING_FRONT) {
            Voice.speak(CameraActivity.this,getString(R.string.back_camera_switched),false);
            useFacing = CameraCharacteristics.LENS_FACING_BACK;
        } else {
            Voice.speak(CameraActivity.this,getString(R.string.front_camera_switched),false);
...
//As above we also have container id
        getFragmentManager().beginTransaction().replace(R.id.containerTwo, fragment).commit();
    }
